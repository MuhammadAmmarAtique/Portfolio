  ...
  return (
    <div>
      ...
      <div className="project">
        <ProjectBox
          projectPhoto={TruckManagementSystemImage}
          projectName="TruckManagementSystem"
        />
        <ProjectBox
          projectPhoto={AuctionPlatformImage}
          projectName="AuctionPlatform"
        />
        <ProjectBox
          projectPhoto={VideoSharingAppImage}
          projectName="VideoSharingApp"
        />
